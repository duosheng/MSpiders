...
import logging
# import SafeRotatingFileHandler
...
fh = SafeRotatingFileHandler(filename='%s/analyzer.log' % settings.Analyzer_LOGPATH, when='D', interval=1, backupCount=7) if settings.LOG_SAVE else None
